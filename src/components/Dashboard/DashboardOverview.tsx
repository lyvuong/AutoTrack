        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pt-1 border-t border-slate-800/60">
          ...
          <div className="flex items-center gap-3 min-w-0 flex-1">
            {activeVehicle.photoUrl ? (
              <img
                ...
                className="w-11 h-11 rounded-lg object-cover border border-cyan-500/40 shrink-0 shadow"
              />
            ) : (
              <div className="w-11 h-11 rounded-lg bg-gradient-to-tr from-cyan-600/80 to-blue-600/80 flex items-center justify-center shrink-0 border border-white/10 shadow">
          ...
          <div className="flex items-center gap-1.5 flex-wrap shrink-0">
            <button
              ...
              className="flex-1 sm:flex-initial bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs px-2.5 py-1.5 rounded-lg shadow-sm shadow-cyan-500/20 transition-all flex items-center justify-center gap-1 active:scale-95"
            >
            ...
            {onOpenAddRefuel && (
              <button
                ...
                className="flex-1 sm:flex-initial bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/40 text-emerald-300 font-bold text-xs px-2.5 py-1.5 rounded-lg transition-all flex items-center justify-center gap-1 active:scale-95"
              >
            ...
            <button
              ...
              className="flex-1 sm:flex-initial bg-amber-500/15 hover:bg-amber-500/25 border border-amber-500/40 text-amber-300 font-bold text-xs px-2.5 py-1.5 rounded-lg transition-all flex items-center justify-center gap-1 active:scale-95"
            >
