    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel p-6 rounded-3xl">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-black text-white font-display">Service History Logs</h1>
          </div>
      ...
      <div className="glass-panel p-4 rounded-2xl space-y-3 no-print">
        ...
        <div className="flex items-center justify-between text-xs text-slate-400 pt-2 border-t border-slate-800">
          <span>Showing <strong className="text-cyan-400">{filteredRecords.length}</strong> service records</span>
      ...
      {filteredRecords.length > 0 ? (
        ...
        <div className="text-center py-16 glass-panel rounded-3xl">
          ...
          <h3 className="text-base font-bold text-white mb-1">No Service Logs Found</h3>
